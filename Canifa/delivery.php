             ...
             <div class="delivery-content row">
                 <div class="delivery-content-left">
                    ...
                    <div class="delivery-content-left-dangnhap row">
                        ...
                        <p>Đăng nhập (Nếu bạn đã có tài khoản của CANIFA)</p>
                    </div>
                    <br>
                   ...
                   <br>
                    ...
                    <div class="delivery-content-left-input-top row">
                        ...
                        <div class="delivery-content-left-input-top-item">
                            ...
                            <select name="customer_tinh" id="tinh_tp" oninvalid="this.setCustomValidity('Vui lòng không để trống')"
                        ...
                        <div class="delivery-content-left-input-top-item">
                            ...
                            <select name="customer_huyen" id="quan_huyen" oninvalid="this.setCustomValidity('Vui lòng không để trống')"
                             oninput="this.setCustomValidity('')" required  name="" id="">
                    ...
                    <div class="delivery-content-left-input-bottom">
                            ...
                            <select name="customer_xa" id="phuong_xa" oninvalid="this.setCustomValidity('Vui lòng không để trống')"
                             oninput="this.setCustomValidity('')" required  name="" id="">
                    ...
                    <div class="delivery-content-left-input-bottom">
                            ...
                            <input name="customer_diachi" oninvalid="this.setCustomValidity('Vui lòng không để trống')"
                             oninput="this.setCustomValidity('')" required  type="text">
                    </div>
